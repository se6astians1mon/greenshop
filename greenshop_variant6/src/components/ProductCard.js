...
export default function ProductCard(props) {
    ...
    const label = () =>{
      return (
        <div gutterBottom className={classes.label} style={{backgroundColor: props.color}} component={'span'}>
        {props.labelpos==="front"?props.labeltext:""}  {props.labelpos==="behind"?props.labeltext:""}
        </div>
      );
    }
    return (
