...
import regularQuestions from './data/questionary_4_5_6.json';
    ...
    <div className="App">
      ...
      <Router history={history}>
        ...
        <Route path='/additionalinformation'
          render={() => {
            setProgress(5);
            setHeaderBarTitle("Label environmental");
            signInAn(userID)
		...
		const redirectlink = "https://www.merciderepondre.com/WebProd/cgi-bin/askiaext.dll?Action=StartSurvey&SurveyName=RET2385&Broker=99&BrokerPanelId="+mailID+"&ID_EXP="+4; 
